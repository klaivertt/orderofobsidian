...
import fr.klaivert.orderofobsidian.structures.SkyStructures;
...
public class STStructures {
     ...
     */
    public static final DeferredRegister<StructureType<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(Registries.STRUCTURE_TYPE, OrderOfObsidianMod.MOD_ID);
