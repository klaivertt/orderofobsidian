...
public class ArmorMaterial {
    ...
    public static final ModArmorMaterial MITHRIL_ARMOR = new ModArmorMaterial(
    ...
    public static final ModArmorMaterial PENDORITE_ARMOR = new ModArmorMaterial(
            new int[] {10, 13, 13, 10}, //Helmet, Chest, leggings, boots
            new int [] {1250, 1800, 1500, 1100},
            40,
            SoundEvents.ARMOR_EQUIP_NETHERITE,
    ...
    public static final ModArmorMaterial OBSIDIAN_ARMOR = new ModArmorMaterial(
            new int[] {3, 6, 6, 2}, //Helmet, Chest, leggings, boots
    ...
    public static final ModArmorMaterial STEEL_ARMOR = new ModArmorMaterial(
