...
public class ModFoods {
    public static final FoodProperties EMERALD_APPLE = (new FoodProperties.Builder()).nutrition(8).saturationMod(1.8F).effect(new MobEffectInstance(MobEffects.HERO_OF_THE_VILLAGE, 1250, 1), 1).effect(new MobEffectInstance(MobEffects.HEALTH_BOOST, 800, 0), 0.8f).alwaysEat().build();
